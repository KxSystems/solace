...
default_nm:`host`vpn`user`pass`destname`type
default_val:(enlist "host.docker.internal";enlist "default";enlist "admin";enlist "admin";enlist "Q/test";enlist "queue")
...
q:`$"queue"
.solace.endpoint_type:0N!`int$(q=`$first params`type)
