 ...
 *
 * @param topic Should be a symbol. The Topic to send data to.
 ...
 * @param replyType Should be an int. 0 for topic, 1 for queue. The topic/queue that you wish a reply to this message to go to
